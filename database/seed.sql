-- DealFlow360 Seed Data (Simple Numbering Scheme)
...
('00000000-0000-0000-0000-000000000204', 'platinum', 'Platinum Global', 25.00);
...
('00000000-0000-0000-0000-000000000304', 'Nexus Logistics Group', '00000000-0000-0000-0000-000000000203', 'USD', '12 Freight Lane, Chicago, IL', '12 Freight Lane, Chicago, IL', 'Marcus Vance', 'marcus@nexuslogistics.com', '+1 555-0811', '00000000-0000-0000-0000-000000000101');
...
('00000000-0000-0000-0000-000000000403', 'Subscriptions', 'subscription', 20.00);
...
('00000000-0000-0000-0000-000000000504', 'SUB-DF-01', 'DealFlow360 Enterprise SaaS Subscription', 'Full sales ops automation, predictive analytics & customer portal access', '00000000-0000-0000-0000-000000000403', 'user/month', 350.00, 50.00, 18.00, true);
...
('00000000-0000-0000-0000-000000000602', '00000000-0000-0000-0000-000000000504', 'Annual Enterprise Plan (Save 15%)', 'yearly', 3570.00, true, 30, true);
...
('00000000-0000-0000-0000-000000000703', 'West Coast Logistics Hub', 'Reno, NV', 1.500);
...
('00000000-0000-0000-0000-000000000804', '00000000-0000-0000-0000-000000000702', '00000000-0000-0000-0000-000000000502', 20, 5);
...
('00000000-0000-0000-0000-000000000902', '00000000-0000-0000-0000-000000000501', '00000000-0000-0000-0000-000000000504', 0.850, 20.00);
...
('00000000-0000-0000-0000-000000001002', 25.00, NULL, ARRAY['sales_manager'::approval_level, 'finance_ops'::approval_level]);
...
('00000000-0000-0000-0000-000000001102', 'Q-2026-102', '00000000-0000-0000-0000-000000000302', '00000000-0000-0000-0000-000000000101', 'draft', 0.00, 3600.00, 180.00, 3420.00);
...
('00000000-0000-0000-0000-000000001203', '00000000-0000-0000-0000-000000001102', '00000000-0000-0000-0000-000000000502', 2, 1800.00, 5.00, 15.00, 3420.00, 35.67, false, false);
...
('00000000-0000-0000-0000-000000001302', '00000000-0000-0000-0000-000000001101', 'finance_ops', 2);

-- 14. Deal Health Alerts (Series 1400)
INSERT INTO deal_health_alerts (id, quotation_id, alert_type, details, status) VALUES
('00000000-0000-0000-0000-000000001401', '00000000-0000-0000-0000-000000001102', 'stalled_deal', '{"days_inactive": 9, "rep_name": "Sales Representative", "customer_name": "Beta Industries Ltd"}', 'open');
